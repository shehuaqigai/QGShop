...
<link href="/xampp/QGShop/Public/css/custom/adminLogin.css" rel="stylesheet"/>
</head>
<body>
<div id="loginForm">
     <table border="0">
     ...
     <tr>
         ...
         <td>
             <div class="verifyCode">
                 ...
                 <img src="/xampp/QGShop/index.php/admin/Index/generatorVerifyCode" alt="看不清"/>
...
<script>
    (function(){
        ...
        refreshCodeLink.addEventListener('click',function(e){
            img.src="/xampp/QGShop/index.php/admin/Index/generatorVerifyCode";
        });
        button.addEventListener('click',function(e){
            ...
            var url="/xampp/QGShop/index.php/Admin/Index/verifyCode";
        ...
        function verifyUser(postData){
            var url="/xampp/QGShop/index.php/Admin/Index/verifyUser";
            ajax(url,postData,function(data){
                if(data == 'ok'){
                    location.href="/xampp/QGShop/index.php/Admin/Index/adminHome";
                }else{
